                ...
                <form action="/komoditas" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_komoditas') is-invalid @enderror"
                            id="nama_komoditas" name="nama_komoditas" autofocus value="{{ old('nama_komoditas') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jenis_komoditas') is-invalid @enderror"
                            id="jenis_komoditas" name="jenis_komoditas" value="{{ old('jenis_komoditas') }}">
                    ...
                    <button class="btn btn-primary mt-4" type="submit">Tambah Komoditas</button>
                </form>
            </div>
        </div>
    </section>
