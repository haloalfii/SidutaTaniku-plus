                ...
                <form action="/kecamatan" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('nama_kecamatan') is-invalid @enderror"
                            id="nama_kecamatan" name="nama_kecamatan" autofocus value="{{ old('nama_kecamatan') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('luas_kecamatan') is-invalid @enderror"
                            id="luas_kecamatan" name="luas_kecamatan" autofocus value="{{ old('luas_kecamatan') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control @error('jumlah_desa') is-invalid @enderror"
                            id="jumlah_desa" name="jumlah_desa" autofocus value="{{ old('jumlah_desa') }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('jumlah_petani') is-invalid @enderror"
                            id="jumlah_petani" name="jumlah_petani" autofocus value="{{ old('jumlah_petani') }}">
